  ...
  return (
    <div className="min-h-screen bg-bg">
      ...
      <section className="mx-auto max-w-3xl px-4 pt-12 sm:px-6 sm:pt-16 lg:pt-20">
        ...
        <p className="mt-4 text-[14px] text-t3">Last updated: May 29, 2026</p>
      </section>

      {/* Body content */}
      <section className="mx-auto max-w-3xl px-4 pb-20 pt-10 sm:px-6 sm:pb-24 sm:pt-14">
        <div className="policy-content space-y-5 text-[16px] leading-relaxed text-nav-text">
          <p>
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Application</strong> refers to Reignara, the software program provided by
                the Company.
              </p>
            </li>
            <li>
              <p>
                ...
                &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to
                Reignara LLC, 5429 N Red Hills Ave.
              </p>
            </li>
            <li>
              <p>
          ...
          <ul>
            ...
            <li>
              ...
              information may be viewed by all users and may be publicly distributed outside. If
              You interact with other users or register through a Third-Party Social Media Service,
              Your contacts on the Third-Party Social Media Service may see Your name, profile,
          ...
          <ul>
            ...
            <li>
              ...
              <ul>
                <li>
                  <p>
                    Application usage statistics: up to 24 months to understand feature adoption
      ...
      <style jsx global>{`
        .policy-content h2 {
          font-family: var(--font-display), 'Bavex', 'Georgia', serif;
          font-size: 28px;
          line-height: 1.2;
          color: var(--t1);
          margin-top: 2.5rem;
